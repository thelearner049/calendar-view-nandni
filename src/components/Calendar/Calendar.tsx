...
//   const { addEvent, editEvent, deleteEvent, getEventsByDate } =
//     useEventManager();
...
//     const clickedDate = setDate(value, day); // changes day of the given month
...
//     setSelectedDate(new Date(event.start)); // based modal on event date
//     setSelectedEvent(event);
//     setOpen(true);
//   };

//   return (
//     <div className="border-t border-l w-[1000px]">
//       <div className="grid grid-cols-7 items-center justify-center text-center">
//         <Cell onClick={prevYear}>{"<<"}</Cell>
//         <Cell onClick={prevMonth}>{"<"}</Cell>
//         <Cell className="col-span-3 font-bold text-lg ">
...
//         {/* Days name mapping */}
//         {dayOfWeek.map((day) => (
//           <Cell key={day} className="text-sm font-bold bg-blue-200 ">
//             {day}
//           </Cell>
//         ))}
...
//                     <div
//                       key={ev.id}
//                       className={`cursor-pointer text-[10px] px-0.5 py-0.5 w-full rounded flex flex-col items-center text-white ${
...
//                         <button
//                           className="bg-black/20 rounded px-1"
//                           onClick={(e) => {
